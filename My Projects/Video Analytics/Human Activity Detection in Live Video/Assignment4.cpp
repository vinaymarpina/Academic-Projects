...
int main(int argc, char** argv)
{
	...
	CvCapture* capture = 0;
	string line;
	// Training input text file which contains all the train videos
	ifstream myfile("C:\\Users\\Vinay\\Desktop\\Spring2015\\VideoAnalytics\\Assignments\\Assignment4\\train.txt");
	if (myfile.is_open())
	{
	...
	string trainline;
	ifstream mytrainfile("C:\\Users\\Vinay\\Desktop\\Spring2015\\VideoAnalytics\\Assignments\\Assignment4\\train.txt");
	...
	ifstream mytestfile("C:\\Users\\Vinay\\Desktop\\Spring2015\\VideoAnalytics\\Assignments\\Assignment4\\test.txt");
	if (mytestfile.is_open())
	{
		while (getline(mytestfile, testline))
		{
			...
			for (; it != tokens.end(); ++it)
			{
				...
				groundTruth.push_back((float)lable);
				//SVM prediction of the given test video
				float response = svm.predict(bowDescriptor2);
				results.push_back(response);
				cout << "Original Class: " << lable;
				cout << "\n";
				cout << "Predicted Class: " << response;
				cout << "\n";
			}
			std::cout << "\n";
		}
	...
	printf("%s%f", "Success rate is ", 100.0-errorRate*100.0);
